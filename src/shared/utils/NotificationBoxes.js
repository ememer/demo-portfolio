export const NotificationBoxes = [
  {
    ...
    shuffle:
      "animate-mobileShuffleCardRight lg:animate-shuffleCardUp bg-opacity-95 bg-mainDark-500",
  ...
  },
  {
    ...
    shuffle:
      "animate-mobileShuffleCardDownLeft lg:animate-shuffleCardUpRight bg-opacity-95 bg-mainDark-500",
  ...
  },
  {
    ...
    shuffle:
      "animate-mobileShuffleCardLeft lg:animate-shuffleCardSlideRight bg-opacity-95 bg-mainDark-500",
