...
const notificationBoxClassName =
  "absolute top-0 lg:top-1/3 right-0 lg:right-1/2 w-full lg:w-3/5 bg-mainDark-900 scale-75 lg:scale-none";
              ...
              <AkcentBox className="relative w-full min-h-50-screen">
                <NotificationBox
                  className={clsx(
                    ...
                    "z-30 animate-mobileSlideRight lg:animate-slideUp"
                  )}
                />
                <NotificationBox
                  className={clsx(
                    notificationBoxClassName,
                    "z-20 animate-mobileSlideDownLeft lg:animate-slideUpRight"
                  )}
                />
                <NotificationBox
                  className={clsx(
                    notificationBoxClassName,
                    "z-10 animate-mobileSlideLeft lg:animate-slideRight"
                  )}
                />
              </AkcentBox>
